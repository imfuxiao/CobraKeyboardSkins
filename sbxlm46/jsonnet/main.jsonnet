...
local iPhonePinyinPortrait = import 'Components/iPhonePinyinPortrait.libsonnet';
local iPhonePinyinLandscape = import 'Components/iPhonePinyinLandscape.libsonnet';
...
local lightPinyinPortraitFileContent = iPhonePinyinPortrait.new(isDark=false, isPortrait=true);
local darkPinyinPortraitFileContent = iPhonePinyinPortrait.new(isDark=true, isPortrait=true);

local pinyinLandscapeFileName = 'pinyinLandscape';
local lightPinyinLandscapeFileContent = iPhonePinyinLandscape.new(isDark=false, isPortrait=false);
local darkPinyinLandscapeFileContent = iPhonePinyinLandscape.new(isDark=true, isPortrait=false);
